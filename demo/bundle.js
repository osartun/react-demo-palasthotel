...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoListItem = __webpack_require__(170);
	        ...
	        _react2.default.createElement(
	          ...
	          this.getTodos().map(function (todo) {
	            return _react2.default.createElement(_TodoListItem2.default, _extends({
	              ...
	              onType: _this2.handleType.bind(_this2),
	              onCheck: _this2.handleCheck.bind(_this2),
	              onFocusChange: _this2.handleFocusChange.bind(_this2)
	            }));
	          })
	        )
	      );
	...
	var TodoListItem = function (_Component) {
	  ...
	  _createClass(TodoListItem, [{
	    ...
	    value: function render() {
	      ...
	      return _React2.default.createElement(
	        "li",
	        { className: "todo-item " + (props.focused ? "focused" : "") + " " + className },
	        _React2.default.createElement(
	          "form",
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(186);
